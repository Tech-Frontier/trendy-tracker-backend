...
public record RecruitDto(
    ...
    public RecruitDto(long id, Company company, String jobCategory, String url, String title, LocalDateTime createTime) {
        this(id, company.getCompany_name(), jobCategory, url, title, createTime, null);
    }

    public RecruitDto(long id, Company company, String jobCategory, String url, String title, LocalDateTime createTime, List<String> techList) {
        this(id, company.getCompany_name(), jobCategory, url, title, createTime, techList);
    }
}
